const colors = ["red", "green", "blue", "magenta", "cyan", "yellow", "orange", "purple", "navy", "hotpink", "'chartreuse'"];
...
function setup() {
    ...
    // circle(this.center, this.center, this.diameter)
...
function createVortex(c, r, m, n) {
    ...
    for (let i = 0; i < n; i++) {
        ...
        if (alpha != i) {
            ...
            // console.log(lineLength, remap(lineLength, 0, width, 0, 10))
            let lineColor = Math.floor(remap(lineLength, 0, width, 0, 360))
            console.log(lineLength, lineColor)
...
remapInt(val, low1, high1, low2, high2) {
    ...
    return this.p5.Math.floor(remapped);
}
